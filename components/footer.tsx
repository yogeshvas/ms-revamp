      ...
      <div className="mx-auto px-7 sm:px-20">
        <div className="grid gap-12 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <p className="text-primary-foreground/80 text-sm mt-4 max-w-sm text-center">
              Streamlining logistics operations with cashless payments, GPS
              tracking, and comprehensive fleet management solutions.
            </p>
          </div>
